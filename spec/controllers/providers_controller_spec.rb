  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Provider" do
        expect do
          post :create,
               params: { provider: valid_attributes },
               session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create,
             params: { provider: invalid_attributes },
             session: valid_session
        expect(response).to be_successful
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested provider" do
        provider = Provider.create! valid_attributes
        put :update,
            params: { id: provider.to_param, provider: new_attributes },
            session: valid_session
        provider.reload
      ...
      it "redirects to the provider" do
        provider = Provider.create! valid_attributes
        put :update,
            params: { id: provider.to_param, provider: valid_attributes },
            session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        provider = Provider.create! valid_attributes
        put :update,
            params: { id: provider.to_param, provider: invalid_attributes },
            session: valid_session
        expect(response).to be_successful
      end
    end
