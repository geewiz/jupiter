...
RSpec.describe ResourceTypesController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      ResourceType.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show,
          params: { id: resource_type.to_param },
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ResourceType" do
        expect do
          post :create,
               params: { resource_type: valid_attributes },
               session: valid_session
      ...
      it "redirects to the created resource_type" do
        post :create,
             params: { resource_type: valid_attributes },
             session: valid_session
        expect(response).to redirect_to(ResourceType.last)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create,
             params: { resource_type: invalid_attributes },
             session: valid_session
        expect(response).to be_successful
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested resource_type" do
        ...
        put :update,
            params: {
              id: resource_type.to_param,
              resource_type: new_attributes,
            },
            session: valid_session
      ...
      it "redirects to the resource_type" do
        ...
        put :update,
            params: {
              id: resource_type.to_param,
              resource_type: valid_attributes,
            },
            session: valid_session
        expect(response).to redirect_to(resource_type)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        ...
        put :update,
            params: {
              id: resource_type.to_param,
              resource_type: invalid_attributes,
            },
            session: valid_session
        expect(response).to be_successful
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the resource_types list" do
      ...
      delete :destroy,
             params: { id: resource_type.to_param },
             session: valid_session
      expect(response).to redirect_to(resource_types_url)
    end
  end
end
